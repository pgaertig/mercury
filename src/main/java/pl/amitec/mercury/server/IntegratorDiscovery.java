...
public class IntegratorDiscovery {
    ...
    public IntegratorDiscovery() {
        ...
        integrators.put(PolsoftToBitbeeIntegrator.NAME, PolsoftToBitbeeIntegrator.class);
        integrators.put(RedbayToBitbeeIntegrator.NAME, RedbayToBitbeeIntegrator.class);
        integrators.put(BusinessCentralToBitbeeIntegrator.NAME, BusinessCentralToBitbeeIntegrator.class);
    }
